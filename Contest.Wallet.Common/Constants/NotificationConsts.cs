namespace Consent.Common.Constants
{
    ...
    {
        public const string RegistrationContext = "Registration";
        public const string PhoneNumberConfirmationSubContext = "Send OTP";
        public const string EmailConfirmationSubContext = "EmailVerification";

...
namespace Contest.Wallet.Common.Repository.Mongo.Abstract
{
    public partial interface IRepository<T> where T : EntityBase
    {
        ...
        /// <summary>
        /// Find any elements of a list satisfies a condition.
        /// </summary>
        /// <param name="where"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Async determines whether find elements of a list satisfies a condition.
        /// </summary>
        /// <param name="where"></param>
        /// <returns></returns>
        Task<IList<T>> FindAsync(Expression<Func<T, bool>> where);

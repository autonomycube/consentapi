...
namespace Contest.Wallet.Api.Auth.Data.Helpers
{
    public static class DbMigrationHelpers
    {
        ...
        public static async Task EnsureIssuerSeedData(IServiceProvider serviceProvider)
        {
            ...
            {
                var testDBContext = scope.ServiceProvider.GetRequiredService<AuthDbContext>();
        ...
        /// </summary>
        private static async Task EnsureSeedIssuerData(AuthDbContext testDbContext)
        {

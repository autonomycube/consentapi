...
{
    public class EmailRepository :  Repository<TblNotifyEmailTemplate, string>, IEmailRepository
    {
        ...
        public EmailRepository(NotificationDbContext context, IUnitOfWork<NotificationDbContext> uow) : base(context)
        {
            _context = context;
            _uow = uow;
        }

...
namespace Contest.Wallet.Api.Tenant.Data.Helpers
{
    public static class DbMigrationHelpers
    {
        ...
        public static async Task EnsureDatabasesMigrated(IServiceProvider services)
        {
            ...
            {
                using (var context = scope.ServiceProvider.GetRequiredService<IssuerDbContext>())
                {
        ...
        public static async Task EnsureIssuerSeedData(IServiceProvider serviceProvider)
        {
            ...
            {
                var testDBContext = scope.ServiceProvider.GetRequiredService<IssuerDbContext>();
        ...
        /// </summary>
        private static async Task EnsureSeedIssuerData(IssuerDbContext testDbContext)
        {
